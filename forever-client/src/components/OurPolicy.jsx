  ...
  return (
    <div className="flex flex-col sm:flex-row justify-around gap-12 sm:gap-8 text-center py-20 text-xs sm:text-sm md:text-base text-gray-700">
      <div>
        ...
        <p className="text-gray-400">Enjoy a hassle-free exchange process for your convenience.</p>
      </div>
      <div>
        ...
        <p className="text-gray-400">We offer a 7-day free return policy for your peace of mind.</p>
      </div>
      <div>
        <img src={assets.support_img} alt="Customer Support Icon" className='w-12 m-auto mb-5' loading="lazy" />
        <p className='font-semibold'>24/7 Customer Support</p>
        <p className="text-gray-400">Our dedicated customer support team is available 24/7 to assist you.</p>
      </div>
    </div>
  )
}
